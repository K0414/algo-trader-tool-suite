...
public:
   ...
   X* operator->() const { return ptr_; }
   // added these Alexy Shelest
   /*
   X& operator<< (bool val)  const { return *ptr_; }
   X& operator<< (short val)  const { return *ptr_; }
   X& operator<< (unsigned short val)  const { return *ptr_; }
   X& operator<< (int val)  const { return *ptr_; }
   X& operator<< (unsigned int val)  const { return *ptr_; }
   X& operator<< (long val)  const { return *ptr_; }
   X& operator<< (unsigned long val)  const { return *ptr_; }
   X& operator<< (float val)  const { return *ptr_; }
   X& operator<< (double val)  const { return *ptr_; }
   X& operator<< (long double val)  const { return *ptr_; }
   X& operator<< (const void* val)  const { return *ptr_; }
   X& operator<<(const char* val)  const { return *ptr_; }
